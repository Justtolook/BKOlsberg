...
<div class="modal fade update-modal" tabindex="-1" role="dialog" aria-labelledby="update-modal" aria-hidden="true">
    <form method="post" action="utils/Interessen/updateIntereset.php">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM Interessen WHERE ID_Interesse = ?";
                    ...
                    if($sql = $dbh->prepare($sql))
                    {
                        ...
                        {
                            $actualElement = new Interesse($row["ID_Interesse"]
                                , $row["Beschreibung"]);
                        }
                    }

                    $gewahlteInteressen = $actualElement->getAllInteressen();
                ?>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="button-delete" class="btn btn-danger" style="display: none;" onclick="deleteInterest(<?php echo $dbid; ?>)">Löschen</button>
                </div>
            </div>
        </div>
    </form>
