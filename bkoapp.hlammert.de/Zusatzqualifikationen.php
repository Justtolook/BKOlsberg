<html>
<head>
    <title>BK Olsberg - Zusatzqualifikationen</title>
    <meta charset="UTF-8">
    ...
    <script src="./script/zusatqualifikationen.js"></script>
...
<div class="modal fade insert-modal" tabindex="-1" role="dialog" aria-labelledby="modal-insert" aria-hidden="true">
    <form method="post" action="utils/Zusatzqualifikationen/insertZusatzqualifikationen.php">
            ...
            <div class="modal-content">
				...
				<div class="modal-body">
					<div class="row">
						...
						<div class="col-md"><input type="text" name="description" placeholder="Bezeichnung eingeben" required></div>
					</div>
					<div class="row">
	...
	<table class="table table-striped">
		...
		<?php
			...
			while($row = $result->fetch_array())
			{
				?>
			<tr>
				<td><?php echo $row["ID_Zusatzqualifikation"]; ?></td>
				<td><?php echo $row["Bezeichnung"]; ?></td>
				<td><button class="btn btn-warning" onclick="createZusatzqualifikationUpdateModal('<?php echo $row["ID_Zusatzqualifikation"]; ?>')">Editieren</button></td>
			</tr>
				<?php
			}
		?>
